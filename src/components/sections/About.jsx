           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                    <strong>H.V.P.M. Amravati - Masters In Computer Application(MCA), (2021-2023)</strong><br></br>
                     Relevant Coursework: Web Developement, Data Structure, Cloud Computing
                      <p>C.G.P.A. :- 7.8</p>
                </li>
               
                 <li>
                    <strong>Bajaj College Of Science, Wardha - Bachelors of Science(Bsc) in Mathematics (2018-2021)</strong>
                    <p>C.G.P.A. :- 7.3</p>
                </li>
              </ul>
            </div>
